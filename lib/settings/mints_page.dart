...
class _MintsPageState extends State<MintsPage> {
                  ...
                  trailing: PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => [
                      const PopupMenuItem(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.info_outline, color: Color(0xFF00FF00)),
                            SizedBox(width: 8),
                            Text(
                              'Details',
                              style: TextStyle(
  ...
  void _showMintDetails(String mintUrl, String unit) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
  ...
  void _showRemoveMintDialog(String mintUrl) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(

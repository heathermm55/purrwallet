...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1623017061;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        15 => wire__crate__api__nostr__init_app_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__api__nostr__get_public_key_from_private_impl(ptr, rust_vec_len, data_len),
        10 => wire__crate__api__cashu__get_wallet_balance_impl(ptr, rust_vec_len, data_len),
        11 => wire__crate__api__cashu__get_wallet_info_impl(ptr, rust_vec_len, data_len),
        12 => wire__crate__api__cashu__get_wallet_proofs_impl(ptr, rust_vec_len, data_len),
        13 => wire__crate__api__cashu__get_wallet_transactions_impl(ptr, rust_vec_len, data_len),
        14 => wire__crate__api__nostr__greet_impl(ptr, rust_vec_len, data_len),
        16 => wire__crate__api__cashu__init_multi_mint_wallet_impl(ptr, rust_vec_len, data_len),
        17 => wire__crate__api__cashu__list_mints_impl(ptr, rust_vec_len, data_len),
        18 => wire__crate__api__cashu__load_existing_wallets_impl(ptr, rust_vec_len, data_len),
        19 => wire__crate__api__cashu__mint_from_quote_impl(ptr, rust_vec_len, data_len),
        20 => wire__crate__api__cashu__mnemonic_to_seed_hex_impl(ptr, rust_vec_len, data_len),
        ...
        28 => wire__crate__api__nostr__public_key_to_npub_impl(ptr, rust_vec_len, data_len),
        29 => wire__crate__api__cashu__receive_tokens_impl(ptr, rust_vec_len, data_len),
        30 => wire__crate__api__cashu__remove_mint_impl(ptr, rust_vec_len, data_len),
        31 => wire__crate__api__nostr__secret_key_to_nsec_impl(ptr, rust_vec_len, data_len),
        32 => wire__crate__api__cashu__seed_hex_to_mnemonic_impl(ptr, rust_vec_len, data_len),
        33 => wire__crate__api__cashu__send_tokens_impl(ptr, rust_vec_len, data_len),
        34 => wire__crate__api__nostr__sign_event_impl(ptr, rust_vec_len, data_len),
        35 => wire__crate__api__cashu__validate_cashu_proof_impl(ptr, rust_vec_len, data_len),
        36 => wire__crate__api__cashu__validate_mnemonic_phrase_impl(ptr, rust_vec_len, data_len),
